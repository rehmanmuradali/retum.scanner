package com.scanner.returm.retumscanner.client.cnic.client.preditor;
...
/**
 * This predictor can be use to predict cnic details
 * The cnic details includes
 * <b>Cnic Date of Birth</b>,
 * <b>Cnic Date of Issue</b>,
 * <b>Cnic Date of Expiry</b>,
 * <b>Cnic Number</b>
 */
public class CnicPredictor implements BasePredictor<CnicModel> {
    ...
    @Override
    public CnicModel process(List<String> dataList, List<FirebaseVisionText.Element> elementList) {
        predictData(dataList);
        CnicModel cnicModel = new CnicModel();
        cnicModel.setCnicNumber(getCnicNumber());
        cnicModel.setCnicIssueDate(getCnicDateOfIssue());
        cnicModel.setCnicExpiryDate(getCnicDateOfExpiry());
        cnicModel.setDateOfBirth(getCnicDateOfBirth());
        return cnicModel;
    }


    private void predictData(List<String> listData) {
    ...
    private void validateDateForIssueAndExpiry(Date date1, Date date2) {
